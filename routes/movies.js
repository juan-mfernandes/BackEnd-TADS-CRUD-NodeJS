...
const { auth } = require('../project/middlewares/auth');
    
moviesRouter.get("/movies", auth, async(req, res) => {
...
moviesRouter.get("/movies/:id", auth, async(req, res) => {
...
moviesRouter.post("/movies", auth, async(req, res) =>{
    const data = req.body;
...
moviesRouter.put("/movies/:id", auth, async(req, res) => {
    const id = Number(req.params.id);
    const data = req.body;
...
moviesRouter.delete("/movies/:id", auth, async(req, res) => {
    const id = Number(req.params.id);
